...
<body>
    ...
    <form method="POST" style="max-width: 500px; background-color: white; padding: 24px; border-radius: 12px; box-shadow: 0 6px 12px rgba(0,0,0,0.05);">
        <div style="margin-bottom: 16px;">
            ...
            <input type="text" name="nama" id="nama" value="<?= $data['nama'] ?>" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 6px;">
        </div>
        <div style="margin-bottom: 16px;">
            <label for="nim" style="display: block; margin-bottom: 6px; font-weight: 600;">NIM</label>
            <input type="text" name="nim" id="nim" value="<?= $data['nim'] ?>" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 6px;">
        </div>
        <div style="margin-bottom: 24px;">
            <label for="jurusan" style="display: block; margin-bottom: 6px; font-weight: 600;">Jurusan</label>
            <input type="text" name="jurusan" id="jurusan" value="<?= $data['jurusan'] ?>" required style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 6px;">
        </div>
